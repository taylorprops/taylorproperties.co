        ...
        <div class="row">
            ...
            <div class="col-md-5 pl-0">
                ...
                <div class="row fixed-top">
                    <div class="col-12">
                        <button type="button" class="btn btn-danger float-right mr-5" id="close_listing_details">
                ...
                <div class="row">
                    <div class="col-12" id="listing_details_div"> </div><!-- ./ .col-12  id="listing_details_div"-->
                </div><!-- ./ .row -->
...
<script>
    ...
    var marker_layer = L.markerClusterGroup({ disableClusteringAtZoom: 18, maxClusterRadius: 40, chunkedLoading: true });
        ...
        var xhr = $.ajax({
            ...
            success: function(response) {
                ...
                */
                ...
                map.off('popupopen').on('popupopen', function() {

                    $('.popup-container').off('click').on('click', function() {
                        var id = $(this).data('id');
